...
namespace Stockpile.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost("login")]
        public async Task<IActionResult> Login(UserForLogingDto userForLoginDto)
        {
            if (userForLoginDto is null)
            {
            ...
            //create a more obscure appsettings token for improved security befor production 
